...
sudo mkdir -p /var/www/www.magento19.dev
sudo chown -R www-data.www-data /var/www/www.magento19.dev
sudo chmod -R 775 /var/www/www.magento19.dev
forceSymLink "/vagrant/src" "/var/www/www.magento19.dev/webroot"
